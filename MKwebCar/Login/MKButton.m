...
-(void)dismissAnimation{
    ...
    _animationGroup.animations = @[basicAnimation1];
    _animationGroup.duration = basicAnimation1.beginTime+basicAnimation1.duration;
    _animationGroup.removedOnCompletion = NO;
    _animationGroup.fillMode = kCAFillModeForwards;
    [_shapeLayer addAnimation:_animationGroup forKey:@"dismissAnimation"];
    
    [self performSelector:@selector(loadingAnimation) withObject:self afterDelay:_animationGroup.duration];
}
